...
/* Main Content */
.main { margin-left: 280px; padding: 30px; min-height: 100vh; transition: margin-left 0.3s ease;}
...
<div class="container">
    ...
    <div class="sidebar-header">
        ...
        <a href="employee_dashboard.php" class="active"><i class="fa-solid fa-chart-line"></i><span>Dashboard</span></a>
