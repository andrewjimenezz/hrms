...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .profile-pic { width: 150px; height: 150px; border-radius: 50%; object-fit: cover; border: 4px solid #0a4f0d; }
        .upload-overlay { position: absolute; bottom: 0; right: 0; background: #0a4f0d; color: white; width: 40px; height: 40px; border-radius: 50%; display: flex; align-items: center; justify-content: center; cursor: pointer; border: 3px solid white; }
        .upload-overlay:hover { background: #06600e; }
        ...
        .form-group input:focus, .form-group select:focus { outline: none; border-color: #0a4f0d; }
...
<div class="container">
    <div class="sidebar">
        ...
        <a href="employee_profile.php" class="active">👤 My Profile</a>
